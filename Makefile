...
test:
	sudo ignite run roylez/ansible-ubuntu --cpus 1 --memory 2GB --ssh -f ${PWD}:/root --name ubuntu
	sudo ignite exec -t ubuntu make
	sudo ignite stop ubuntu
	sudo ignite rm ubuntu
